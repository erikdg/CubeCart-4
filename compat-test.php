...
<html>
<head>
<title>CubeCart v4 Compatibility Check</title>
<style type="text/css">
html, body {
	font-size: 11px;
...
if ($encoder) {
	if (!$fail) {
		echo '<span class="pass">Congratulations.<br />Your server looks like it is compatible with CubeCart v4</span>';
	} else {
...
<div class="footer">
  <strong>Notes:</strong> 
  <ul>
  	<li>Ioncube OR Zend Optimizer is required for CubeCart to work at all.</li>
    <li>GD Image Library is required for dynamic image manipulation.</li>
    <li>PHP 5.1.0 Is the minimum version CubeCart will work with.</li>
   	<li> MySQL 4.1.0 is the minimum version CubeCart will work with.</li>
