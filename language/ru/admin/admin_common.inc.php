...
'setup_folder_exists' => "ПРЕДУПРЕЖДЕНИЕ: Папка установки CubeCart 'setup/' существует на вашем сервере. Она должна быть незамедлительно удалена, так как ваш магазин под угрозой.",
...
'other_welcome_note' => "Добро Пожаловать в CubeCart&trade; Административная Панель Управления",
...
'other_visit_cc' => "Посетите Сервер Загрузок CubeCart  ",
