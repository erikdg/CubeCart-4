...
'enter_key' => "C&oacute;digo de Licencia del Software CubeCart:",
...
'upgrade_existing' => "Elija esta opci&oacute;n para actualizar su tienda CubeCart a la &uacute;ltima versi&oacute;n. <br />
...
'upgrade_cubecart' => "Actualice CubeCart",
'fresh_install' => "Elija una opci&oacute;n si desea realizar una instalaci&oacute;n fresca de CubeCart.<br />
...
'install_cubecart' => "Instalar CubeCart",
...
'installation' => "Configuraci&oacute;n CubeCart v%1\$s",
...
<p><strong>Por qu&eacute; obtengo el mensaje de error &quot;Call a una funci&oacute;n no definida: imagecreatefromjpg()&quot;?<br />
  </strong>Esto se debe a que su servidor web no est&aacute; configurado para tener a GD habilitado. Para correr CubeCart, se requiere la versi&oacute;n GD 1 o superior. Por favor contacte a su anfitri&oacute;n y p&iacute;dale amablemente que se la habilite, pero recuerdo que no est&aacute;n obligados a hacerlo.  Si tampoco puede utilizar GD, busque una compa&ntilde;&iacute;a alternativa de alojamiento para establecer su versi&oacute;n GD como &quot;None&quot;.</p>",
'mysqlDBSettings' => "Configuraciones de la Base de datos MySQL",
'mysqlDBSettingsDesc' => "<p>Para correr CubeCart en su servidor debe tener la base de datos MySQL para que &eacute;sta almacene informaci&oacute;n como los detalles de su producto y cliente. Si est&aacute; intentando instalar CubeCart en un ambiente de alojamiento compartido (virtual), su proveedor de alojamiento deber&iacute;a poder proveerle la informaci&oacute;n requerida para esta etapa del proceso de instalaci&oacute;n. Esta informaci&oacute;n deber&iacute;a incluir el nombre de la base de datos, nombre de usuario, contrase&ntilde;a y el nombre del anfitri&oacute;n. A veces encontrar&aacute; que puede configurar y administrar su base(s) de tados MySQL desde su panel de control de alojamiento. Sin embargo, si est&aacute; instalando CubeCart en una m&aacute;quina de prueba o un servidor dedicado, puede que necesite consultar el <a href='http://dev.mysql.com/doc/mysql/en/index.html' target='_blank'>manual de MySQL</a>. </p>
<p><strong>&iquest;Para qu&eacute; se utiliza el prefijo de la base de datos?</strong>
<br />
El script de instalaci&oacute;n de CubeCart crear&aacute; tablas dentro de su base de datos MySQL que son esenciales para que funcione. Si desea instalar muchas tiendas diferentes, y s&oacute;lo tiene una base de datos, estas tablas tendr&aacute;n que distinguirse las unas de las otras de alguna forma. Esto se logra poniendo un prefijo delante de cada tabla de base de datos para cada tienda.</p>",
...
'subscribe' => 'Subscribe to CubeCart Mailing List',
'subscribe_desc' => 'Receive important news and updates concerning CubeCart development and releases.'
