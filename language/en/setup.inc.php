...
'enter_key' => "CubeCart Software License Key:",
...
'upgrade_existing' => "Choose this option to upgrade your CubeCart store to the latest version. <br />
	  <strong style='color: red;'>IMPORTANT:</strong> Please take a FULL backup of your database and files before continuing!",
'upgrade_cubecart' => "Upgrade CubeCart",
'fresh_install' => "Choose this option if you wish to perform a fresh installation of CubeCart.<br />
	  <strong style='color: red;'>WARNING</strong>: By proceeding with this option any existing store data may be overwritten!",
'install_cubecart' => "Install CubeCart",
...
'tryAgain' => "Try Again",
'contToStep' => "Continue to Step %1\$s",
