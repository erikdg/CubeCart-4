...
|	licForm.inc.php
|   ========================================
|	Used For CubeCart Copyright Removal
+--------------------------------------------------------------------------
*/
...
if(isset($_GET['r']) && $_GET['r']=='T' && isset($_GET['l']) && !empty($_GET['l'])){
	...
	if ($result){
		httpredir('https://www.cubecart.com/external/licVer4.php?step=2&v=4&licKey='.$_GET['l']);
	} else {
		echo $header;
?>
...
<table width="100%" border="0" cellpadding="3" cellspacing="1" class="mainTable">
  ...
  <tr>
    ...
    <p><a href="https://www.cubecart.com/site/purchase/" class="txtLink" target="_blank"><?php echo $lang['admin']['misc_purchase_license_key']; ?></a> | <a href="<?php echo $glob['adminFile']."?_g=misc/licForm";?>" class="txtLink" target="_self"><?php echo $lang['admin']['misc_try_again']; ?></a></p></td>
  </tr>
</table>
<?php
...
?>
<form name="licForm" method="post" action="https://www.cubecart.com/external/licVer4.php?step=1" style="padding: 0px; margin: 0px;"><table width="100%" border="0" cellpadding="3" cellspacing="1" class="mainTable">
  <tr>
  ...
  <tr>
    ...
    <p><a href="https://www.cubecart.com/site/purchase/" class="txtLink" target="_blank"><?php echo $lang['admin']['misc_purchase_license_key']; ?></a></p></td>
  </tr>
  <tr>
