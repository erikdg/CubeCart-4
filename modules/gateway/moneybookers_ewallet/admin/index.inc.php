...
if(isset($_GET['reset']) && $_GET['reset']){
	$db->misc("DELETE FROM `".$glob['dbprefix']."CubeCart_Modules` WHERE `module` = 'gateway' AND `folder` = 'moneybookers_ewallet'");
	$db->misc("DELETE FROM `".$glob['dbprefix']."CubeCart_config` WHERE `name` = 'moneybookers_ewallet'");
...
?>
<p><a href="http://www.moneybookers.com/partners/cubecart/" target="_blank"><img src="modules/<?php echo $moduleType; ?>/<?php echo $moduleName; ?>/admin/logo.gif" alt="" border="0" title="" /></a></p>
<p class="copyText">&quot;And money moves .&quot;</p>
<p>To have access to the international payment network of Moneybookers please <a href='https://www.moneybookers.com/app/register.pl' class="txtLink">register here</a> for a free account if you don’t have one yet.</p> More information can be found <a href='http://www.moneybookers.com/partners/cubecart/' class='txtLink'>here</a>. <a href="http://www.moneybookers.com/ads/merchant-account/resources/pdfs/mb-merchant-requirements.pdf" class="txtLink" />Merchant requirements</a>
<?php
...
<table width="100%" border="0" cellpadding="3" cellspacing="1" class="mainTable">
  ...
  <tr>
   ...
   <tr>
    ...
    <td class="tdText"><input type="text" name="module[desc]" value="<?php if(empty($module['desc'])) { echo "Moneybookers eWallet"; } else { echo $module['desc']; } ?>" class="textbox" size="30" /></td>
  </tr>
