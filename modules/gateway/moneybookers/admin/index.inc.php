...
if(isset($_GET['reset']) && $_GET['reset']){
	$db->misc("DELETE FROM `".$glob['dbprefix']."CubeCart_Modules` WHERE `module` = 'gateway' AND `folder` = 'moneybookers'");
	$db->misc("DELETE FROM `".$glob['dbprefix']."CubeCart_config` WHERE `name` = 'moneybookers'");
