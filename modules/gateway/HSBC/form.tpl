...
<table width="100%" cellpadding="3" cellspacing="0" border="0">
	...
	<tr align="left">
		<td><strong>Verification Code <font color=red>*</font>:</strong>
	  <td colspan="3"><input type="text" name="cvc2" value="" size="{MAX_CVV2}" maxlength="{MAX_CVV2}" class="textbox" /></td>
	</tr>
	<tr>
		<td colspan="4">&nbsp;</td>
	</tr>
	...
	<tr align="left">
		...
		<td colspan="3">
		<input type="text" name="state" value="{VAL_COUNTY}" class="textbox" />
		</td>
		</tr>
		<tr align="left">
		<td>
