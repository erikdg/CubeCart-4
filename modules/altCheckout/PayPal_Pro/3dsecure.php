...
<body onload="onLoadHandler();">
  <form name="processform" method="post" action="<?php echo $_SESSION['centinel_data']['ACSUrl']; ?>" />
	<input type="hidden" name="PaReq" value="<?php echo $_SESSION['centinel_data']['Payload']; ?>" />
	<input type="hidden" name="TermUrl" value="<?php echo $_SESSION['centinel_data']['TermUrl']; ?>" />
