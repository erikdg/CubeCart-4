...
<table width="100%" cellpadding="3" cellspacing="0" border="0">
	...
	<tr align="left">
		...
		<td nowrap="nowrap"><strong>{LANG_LAST_NAME}</strong></td>
	...
	<tr align="left">
	    ...
	    <td nowrap="nowrap"><strong>{LANG_CARD_TYPE}</strong></td>
...
<select name="expirationYear" class="textbox">
  ...
  <!-- END: expiration_years -->
      ...
      &nbsp;
	<!-- BEGIN: 3ds_logo -->
		  <a href="modules/altCheckout/PayPal_Pro/mcsc.htm" target="_blank"><img src="modules/altCheckout/PayPal_Pro/mcsc.gif" alt="MasterCard SecureCode" border="0" /></a>
		  <a href="modules/altCheckout/PayPal_Pro/vbv.htm" target="_blank"><img src="modules/altCheckout/PayPal_Pro/vbv.gif" alt="Verified by Visa" border="0" /></a>
	<!-- END: 3ds_logo -->
      </td>
	</tr>
	<tr align="left">
	  <td align="left" nowrap="nowrap"><strong>{LANG_SECURITY_CODE}</strong>    
	...
	<tr>
	  <td colspan="4">
		Your card may be eligible or enrolled in the Verified by Visa or MasterCard SecureCode authentication programs.
		After clicking the 'Complete Payment' button, your Card Issuer may prompt you for your payer authentication password to complete your purchase.
	  </td>
	</tr>
	<!-- END: 3ds -->
	<tr>
...
<!-- BEGIN: 3ds -->
<p><strong>For your security, please fill out the form below to complete your order.</strong><br />
Do not click the refresh or back button or this transaction may be interrupted or cancelled.</p>
<center>
  <iframe style="width:400px; height:400px; margin: 0px auto; border: 1px solid #CCCCCC;" scrolling="auto" src="{STORE_URL}/modules/altCheckout/PayPal_Pro/3dsecure.php"></iframe>
</center>
<br />
<!-- END: 3ds -->