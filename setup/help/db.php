...
<title><?php echo $lang['setup']['installHelp']; ?> <?php echo $lang['setup']['helpDatabase']; ?></title>
...
<div style="font-size: 16px; color: #0971CE; font-weight: bold; padding-top: 5px; padding-bottom: 5px;"><?php echo $lang['setup']['mysqlDBSettings']; ?></div>
<?php echo $lang['setup']['mysqlDBSettingsDesc']; ?>
</body>
</html>