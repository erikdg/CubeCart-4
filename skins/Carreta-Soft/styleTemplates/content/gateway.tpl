...
<form action="{VAL_FORM_ACTION}" method="{VAL_FORM_METHOD}" id="gateway" name="gateway" target="{VAL_TARGET}">
<!-- BEGIN: choose_gate -->
...
<p><img src="skins/{VAL_SKIN}/styleImages/progress.gif" alt="Payment Gateway Progress" onload="document.getElementById('gateway').submit();" /></p>
</div>
<!-- END: auto_submit-->
<!-- BEGIN: manual_submit-->
...
<!-- END: transfer -->
<!-- BEGIN: button -->
<div class="BlueBg" style="padding:5px 5px 5px 0;"><a href="javascript:submitDoc('gateway');" class="txtButton">{LANG_CHECKOUT_BTN}</a></div>
<!-- END: button -->
</form>
