...
<td width="80" class="{TD_CART_CLASS}" align="center">{VAL_IND_PRICE}</td>
<td width="80" class="{TD_CART_CLASS}" align="right" nowrap="nowrap">{VAL_LINE_PRICE}</td>
</tr>
<!-- BEGIN: stock_warn -->
<tr>
...
<td width="80" align="right" class="shipping">{VAL_SHIPPING}</td>
</tr>
...
<td>
<div class="BlueBg">
<div class="ButtonLt"><a href="javascript:submitDoc('cart');" class="txtButton" title="Update Cart">{LANG_UPDATE_CART}</a></div>
</div>
</td>

<td>
<div class="BlueBg">
<div class="ButtonRt"><a href="{CONT_VAL}" class="txtButton" title="{LANG_CHECKOUT_BTN}">{LANG_CHECKOUT_BTN}</a></div>
</div>
</td>
</tr>
</table>
