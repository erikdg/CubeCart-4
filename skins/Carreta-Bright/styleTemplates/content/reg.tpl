...
<tr>
<td>{LANG_TITLE}</td>
<td><input name="title" type="text" class="textbox" id="title" size="5" value="{VAL_TITLE}" tabindex="1" /> <small>{LANG_TITLE_DESC}</small></td>
...
<td><input name="firstName" type="text" class="textbox" id="firstName" size="16" value="{VAL_FIRST_NAME}" tabindex="2" /> {ICON_REQUIRED}</td>
...
<td><input name="lastName" type="text" class="textbox" id="lastName" size="16" value="{VAL_LAST_NAME}" tabindex="3" /> {ICON_REQUIRED}</td>
...
<td><input name="email" type="text" class="textbox" id="emailaddr" size="16" value="{VAL_EMAIL}" tabindex="4" /> 
{ICON_REQUIRED}</td>

<td>{LANG_TOWN}</td>
<td><input name="town" type="text" class="textbox" id="town" size="16" value="{VAL_TOWN}" tabindex="10" /> {ICON_REQUIRED}</td>
</tr>
...
<tr>
  <td>{LANG_MOBILE}</td>
  <td><input name="mobile" type="text" class="textbox" id="mobile" size="16" value="{VAL_MOBILE}" tabindex="6" />
  &nbsp;</td>
<td>{LANG_COUNTRY}</td>
...
<td colspan="8">
<div class="BlueBg">
<div class="ButtonRt"><a href="javascript:submitDoc('registerForm');" class="txtButton" tabindex="19">{LANG_REGISTER_SUBMIT}</a></div>
</div></td>
</tr>
</table>
</form>
