...
{JS_COUNTY_OPTIONS}
<div class="txtContentTitle">{LANG_VIEW_CART}</div>
<div class="boxContent">
  ...
  <!-- END: cart_false -->
  <!-- BEGIN: cart_true -->
  <form name="cart" method="post" id="cart" action="{VAL_FORM_ACTION}"><br />
    <!-- BEGIN: edit_delivery -->
    ...
    <table width="100%" border="0" cellpadding="3" cellspacing="0">
      <tr>
        <td class="tdcartTitle" width="15">&nbsp;</td>
        <td align="center" class="tdcartTitle" width="20">{LANG_QTY}</td>
        <td align="center" class="tdcartTitle" width="60">&nbsp;</td>
        ...
        <td class="tdcartTitle" align="right" width="80">{LANG_PRICE}</td>
        <td width="80" align="right" nowrap='nowrap' class="tdcartTitle">{LANG_LINE_PRICE}</td>
      </tr>
      <!-- BEGIN: repeat_cart_contents -->
      <tr>
        <td align="center" class="{TD_CART_CLASS}" width="15"><a href="index.php?_g=co&amp;_a={VAL_CURRENT_STEP}&amp;remove={VAL_PRODUCT_KEY}"><img src="skins/{VAL_SKIN}/styleImages/del.gif" alt="{LANG_DELETE}" width="12" height="12" border="0" title="{LANG_DELETE}" /></a></td>
        <td align="center" class="{TD_CART_CLASS}" width="20"><!-- BEGIN: quanEnabled -->
        ...
        <td align="left" class="{TD_CART_CLASS}" width="60"><img src="{VAL_IMG_SRC}" alt="" width="50" title="" /></td>
        ...
        <td width="80" align="right" class="{TD_CART_CLASS}">{VAL_IND_PRICE}</td>
    ...
    <div style="float: left; line-height: 22px; margin-bottom: 3px; position:relative;" ><a href="javascript:submitDoc('cart');" class="txtButton">{LANG_UPDATE_CART}</a> {LANG_UPDATE_CART_DESC}</div>
    <div style="text-align: right; margin-top: 4px; margin-bottom: 3px;"><a href="{CONT_VAL}" class="txtButton">{LANG_CHECKOUT_BTN}</a></div>
  </form>
  <!-- BEGIN: alt_checkout -->
  <br clear="all" />
  <div style="text-align: right; font-weight: bold;">{LANG_ALTERNATIVE_CHECKOUT}</div>
  <!-- BEGIN: custom_warn -->
